...
#ifndef VILAS_TABLE_VIEW_SWIFT_H
#define VILAS_TABLE_VIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Vilas_table_view",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16Vilas_table_view11AppDelegate")
...
SWIFT_CLASS("_TtC16Vilas_table_view13SceneDelegate")
...
SWIFT_CLASS("_TtC16Vilas_table_view14ViewController")
...
SWIFT_CLASS("_TtC16Vilas_table_view24myTableCellTableViewCell")
@interface myTableCellTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified myBMW;
